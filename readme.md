...
Платформа для поиска команды и участников в IT-проекты. Позволяет создавать проекты, находить единомышленников и управлять составом команд.

## Автор
**Азаров Руслан Романович**  
[GitHub](https://github.com/XSweetyX) 

## Техно-стек
- **Backend:** Python 3.11+, Django 5.2
- **Database:** PostgreSQL
- **Frontend:** HTML5, CSS3, Bootstrap 5
- **Dependencies:** Pillow, python-decouple, psycopg2-binary
...
Перед началом работы необходимо клонировать проект, создать и активировать виртуальное окружение Python.  
1. **Клонируйте проект**
    ```bash
    git clone https://github.com/XSweetyX/team-finder-ad.git
...
Убедитесь, что PostgreSQL запущен локально. Сгенерируйте и примените миграции для создания структуры БД:
```bash
python manage.py makemigrations
python manage.py migrate
```

Для быстрого тестирования используйте встроенную команду:
```bash
python manage.py load_demo_data
```
>Эта команда создаст 3 тестовых пользователя и 5 проектов с участниками.
...
Админка - по адресу [http://127.0.0.1:8000/admin](http://localhost:8000)
